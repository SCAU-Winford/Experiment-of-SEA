...
HD_PWD='F:/Experiment_of_SEA/FPGA_Experimental_Project/Lab_2_1/Lab_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_2_1.tcl -notrace
