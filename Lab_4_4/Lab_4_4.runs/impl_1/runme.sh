...
HD_PWD='F:/Experiment_of_SEA/FPGA_Experimental_Project/Lab_4_4/Lab_4_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_4_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_4_4.tcl -notrace
