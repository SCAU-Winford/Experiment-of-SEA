...
HD_PWD='F:/Experiment_of_SEA/FPGA_Experimental_Project/Lab_7_2/Lab_7_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_7_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_7_2.tcl
