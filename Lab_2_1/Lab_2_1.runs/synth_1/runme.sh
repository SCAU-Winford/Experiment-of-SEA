...
HD_PWD='F:/Experiment_of_SEA/FPGA_Experimental_Project/Lab_2_1/Lab_2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_2_1.tcl
